...
// STATE & STORAGE
// ============================================
// `state`, `loadState()` și `saveState()` au fost mutate în storage.js
// (vezi index.html — storage.js este încărcat înainte de app.js).
...
// HELPERS
// ============================================
// escHtml(), formatDate(), showToast() au fost mutate în utils.js
// (vezi index.html — utils.js este încărcat înainte de app.js).
